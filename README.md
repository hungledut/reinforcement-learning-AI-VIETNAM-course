...
The Deep Reinforcement Learning (DRL) consist of 2 main types. One of those is Model-Free DRL, including Value-based and Policy-based RL. This is two sub-types that we study in this course. 
![RL overview2](images/RL2.png)
